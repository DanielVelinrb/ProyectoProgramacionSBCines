...
public class GUICompraAsistida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(lblHorarioFuncion, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 29, -1, -1));
        ...
        getContentPane().add(cmbHorarios, new org.netbeans.lib.awtextra.AbsoluteConstraints(137, 26, -1, -1));
        ...
        getContentPane().add(btnEscogerAsiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(299, 64, -1, -1));

        tblAsientosAsistidos.setFont(new java.awt.Font("Century", 0, 11)); // NOI18N
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 350, 660, 186));
        ...
        getContentPane().add(btnRegistrarCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 550, -1, -1));
        ...
        getContentPane().add(cmbFila, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 65, -1, -1));
        ...
        getContentPane().add(lblFila, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 68, -1, -1));
        ...
        getContentPane().add(lblColumna, new org.netbeans.lib.awtextra.AbsoluteConstraints(137, 68, -1, -1));

        cmbColumna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "A", "B", "C", "D", "E", "F", "G", "H", "I", "J" }));
        cmbColumna.setSelectedIndex(-1);
        getContentPane().add(cmbColumna, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 65, -1, -1));
        ...
        getContentPane().add(pnlAlimentos, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 105, -1, -1));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 950, 660));
